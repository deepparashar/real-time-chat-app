...
import {io, userSocketMap} from '../dev-server.js'
...
//Function mark messages as seen
export async function markSeenMessage(req,res){
try {
    const {id} = req.params;
...
export async function sendMessages(req,res){
    try {
        ...
        //emit the new message to the reciever's socket.io
